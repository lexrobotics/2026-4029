...
//                bot.outtakeWrist.setTarget(((Wrist.MAX - Wrist.MIN) / 2.0) + ((Wrist.MAX - Wrist.MIN) / 2.0) * -gamepad1.left_stick_y);
...
//                bot.v4b.setTarget(((V4B.MAX - Wrist.MIN) / 2.0) + ((V4B.MAX - Wrist.MIN) / 2.0) * -gamepad1.right_stick_y);
