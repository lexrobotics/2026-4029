...
/*
        ...
        bot.drivetrain.setTrajectorySequence(paths.buildRedRightTrajectory(bot.drivetrain, 2));
        actionSequences.OuttakeRest(false);
        while(opModeIsActive() && bot.isBusy()){
            bot.update();
        }

        bot.drivetrain.setTrajectorySequence(paths.buildRedRightTrajectory(bot.drivetrain, 3));
        actionSequences.OuttakeRest(false);
        while(opModeIsActive() && bot.isBusy()){
            bot.update();
        }*/
