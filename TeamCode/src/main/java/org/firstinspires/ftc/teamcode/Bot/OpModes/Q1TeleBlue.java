...
//            driver2();
    ...
    private void driver1(){
        ...
        telemetry.addData("targetsdrive1", bot.drivetrain.teleOpTargets[0]);
        telemetry.addData("targetsdrive2", bot.drivetrain.teleOpTargets[1]);
        telemetry.addData("targetsdrive3", bot.drivetrain.teleOpTargets[2]);
